...
class InitiativesControllerTest < ActionController::TestCase
  ...
  test "should create initiative" do
    assert_difference('Initiative.count') do
      post :create, initiative: { active: @initiative.active, description: @initiative.description, hashtag: @initiative.hashtag, image: @initiative.image, ngo_id: @initiative.ngo_id, title: @initiative.title }
    end
  ...
  test "should update initiative" do
    patch :update, id: @initiative, initiative: { active: @initiative.active, description: @initiative.description, hashtag: @initiative.hashtag, image: @initiative.image, ngo_id: @initiative.ngo_id, title: @initiative.title }
    assert_redirected_to initiative_path(assigns(:initiative))
  end
